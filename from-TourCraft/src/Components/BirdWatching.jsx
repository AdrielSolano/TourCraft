...
// Import bird watching specific images
import img from '../assets/birdsss.jpg';
import th1 from '../assets/birdsss.jpg';
import th2 from '../assets/birdsss.jpg';
import th3 from '../assets/birdsss.jpg';
...
const iconMap = {
    "Eco Tours": Nature,
    "Wildlife Watching": Explore,
    "Nature & Adventure": DirectionsWalk,
    "Birding Expeditions": DirectionsBus,
};

const texts = [
    "Early morning pickup at your hotel (5:30 AM)",
    "Transfer to Yum Balam Nature Reserve (30 minutes)",
    "Guided bird watching session (3 hours) - Spot flamingos, herons, pelicans and endemic species",
    "Breakfast with local flavors at observation point (1 hour)",
    "Mangrove exploration by boat (1.5 hours)",
    "Photography session at prime bird habitats (1 hour)",
    "Educational talk about Holbox ecosystems (45 minutes)",
    "Return transfer to your hotel (30 minutes)"
];
        ...
        <Box sx={{ backgroundColor: '#ffffff', color: '#333333' }}>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
                                    ...
                                    {[th1, th2, th3].map((img, index) => (
                                        <Grid item xs={4} key={index}>
                                            <CardMedia
                                                component="img"
                                                image={img}
                                                alt={`Bird watching thumbnail ${index + 1}`}
                                                sx={{
                                                    borderRadius: '12px',
                                                    width: '100%',
                                                    height: 'auto'
                            ...
                            <Box>
                                ...
                                <Typography variant="body1" sx={{ lineHeight: '30px', mb: 2, fontFamily: "Playfair Display" }}>
                                    {zona ? zona.descripción : 'Holbox Island is a premier birding destination within the Yum Balam Biosphere Reserve, home to over 150 bird species including pink flamingos, pelicans, herons, and rare endemics. Our expert-guided bird watching tours take you through diverse ecosystems - mangroves, beaches, and lagoons - at optimal viewing times. The experience includes high-quality binoculars, bird identification guides, and photography tips. Morning tours maximize wildlife activity while minimizing human disturbance in these protected habitats.'}
                                </Typography>
                            </Box>
                            ...
                            <Box>
                                ...
                                <Box sx={{ borderRadius: '25px', overflow: 'hidden' }}>
                                    <iframe
                                        ...
                                        frameBorder="0"
                                        style={{ border: 0 }}
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d119066.077249376!2d-87.461824!3d21.543333!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f4c2b05aef653db%3A0x6901b5ab5a8b8a86!2sYum%20Balam%20Reserve%2C%20Holbox!5e0!3m2!1sen!2smx!4v1620000000000!5m2!1sen!2smx"
                                        allowFullScreen=""
                                        loading="lazy"
                            ...
                            <Box>
                                <List sx={{ width: '100%', bgcolor: 'transparent', padding: 0 }}>
                                    {[
                                        { icon: Groups, text: 'Group size: 4-8 people' },
                                        { icon: Schedule, text: 'Duration: 5-6 hours (early morning)' },
                                        { icon: Paid, text: 'Price: $75-$95 per person' },
                                        { icon: DirectionsBus, text: 'Includes: Guide, equipment, breakfast' }
                                    ].map((item, index) => (
            ...
            <Box sx={{ py: 7.5, borderTop: '1px solid rgba(0,0,0,0.1)' }}>
                <Container maxWidth="lg">
                    <Typography variant="h2" align="center" sx={{ fontWeight: 700, mb: 7.5, fontFamily: "Playfair Display" }}>
                        Nearby Birding Spots in Holbox
                    </Typography>
                        ...
                        {[
                            {
                                ...
                                description: 'Shallow sandbar attracting flamingos, herons, and migratory shorebirds...',
                                url: "https://www.holboxisland.com/punta-mosquito/"
                            },
                            {
                                image: Rectangle161,
                                title: 'Yalahau Lagoon',
                                description: 'Freshwater habitat perfect for observing kingfishers and waterfowl...',
                                url: "https://www.holboxisland.com/yalahau-lagoon/"
                            },
                            {
                                image: Rectangle162,
                                title: 'Holbox Mangroves',
                                description: 'Protected mangrove forests with specialized bird species...',
                                url: "https://www.yumbalam.org/mangroves"
                            }
                        ].map((place, index) => (
            ...
            <Box sx={{ py: 7.5, borderTop: '1px solid rgba(0,0,0,0.1)', overflow: 'hidden', marginBottom: '100px' }}>
                <Container maxWidth="lg">
                    ...
                    >
                        Bird Enthusiasts Share Their Experiences
                    </Typography>
                        ...
                        {[
                            {
                                ...
                                comment:
                                    "As an amateur ornithologist, I was blown away by Holbox's bird diversity. Our guide spotted 42 species in one morning! The flamingo colonies at Punta Mosquito were breathtaking. The provided Swarovski binoculars made all the difference.",
                            },
                            {
                                image: lg2,
                                name: 'Emily Wilson',
                                location: 'London, UK',
                                comment:
                                    "The sunrise birding tour was magical. We saw roseate spoonbills fishing just meters away. The guide's knowledge of migratory patterns and bird calls transformed this from a simple tour into an educational experience I'll never forget.",
                            },
