          ...
          <Grid item xs={12} md={6}>
            <Stack spacing={4}>
              <Box>
                ...
                >
                  Playa Delfines is one of Cancun's most beautiful and pristine beaches, 
                  known for its stunning views of the Caribbean Sea and the iconic "Cancun" 
                  sign. This public beach offers crystal clear waters and powdery white sand 
                  without the crowds of the hotel zone.
                </Typography>
              </Box>
              ...
              <Box>
                ...
                <Stack spacing={1}>
                  <Typography sx={{ fontFamily: "Playfair Display", color: "#666" }}>
                    • Breathtaking panoramic views of the Caribbean
                  </Typography>
                  <Typography sx={{ fontFamily: "Playfair Display", color: "#666" }}>
                    • Iconic "Cancun" sign for perfect photos
                  </Typography>
                  <Typography sx={{ fontFamily: "Playfair Display", color: "#666" }}>
