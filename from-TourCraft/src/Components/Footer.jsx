...
const Footer = () => {
  ...
  // Función para manejar el scroll al hacer clic en links
  ...
  // Efecto para manejar scroll al cambiar de ruta
  useEffect(() => {
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: '20px', alignItems: { xs: 'center', md: 'flex-start' }, textAlign: { xs: 'center', md: 'left' } }}>
              ...
              <Box sx={{ display: 'flex', gap: '12px', opacity: 0.5 }}>
                <SocialIcon 
                  icon={Social} 
                  alt="Facebook" 
                  href="https://www.facebook.com/TourCraft"
                />
                <SocialIcon 
                  icon={Twitter} 
                  alt="Twitter" 
                  href="https://x.com/TourCraft174709?t=KoKUHcmLKYn-X5lVomeQIA&s=08" 
                />
                <SocialIcon 
                  icon={Insta} 
                  alt="Instagram" 
                  href="https://www.instagram.com/tourc_raft?igsh=MTc2bHlnNDF6YXRpOQ==" 
                />
              </Box>
            </Box>
          </Grid>
