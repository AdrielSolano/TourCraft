          ...
          <Grid item xs={12} md={6}>
            <Stack spacing={4}>
              <Box>
                ...
                >
                  Gran Cenote is one of the most beautiful and accessible cenotes near Tulum. 
                  This natural swimming hole features crystal clear waters, impressive stalactites 
                  and stalagmites, and is perfect for swimming, snorkeling, and diving. The 
                  cenote is surrounded by lush jungle vegetation.
                </Typography>
              </Box>
