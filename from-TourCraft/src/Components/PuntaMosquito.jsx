...
// Importar imágenes para Punta Mosquito
import img from '../assets/mosquito.webp';
import th1 from '../assets/mosquito.webp';
import th2 from '../assets/mosquito.webp';
import th3 from '../assets/mosquito.webp';
...
const iconMap = {
    ...
    "Wildlife Tours": CardTravel,
    "Eco Tours": DirectionsWalk,
    "Water Activities": DirectionsBus,
};

const texts = [
    "Pickup at your hotel or main pier in Holbox (15 minutes)",
    "Boat ride to Punta Mosquito (30-40 minutes depending on weather)",
    "Arrival at Punta Mosquito sandbar - Guided tour of the area (1 hour)",
    "Flamingo spotting and wildlife observation (45 minutes)",
    "Snorkeling in the crystal-clear waters (1 hour)",
    "Relaxation time on the sandbar (45 minutes)",
    "Return boat ride to Holbox (30-40 minutes)",
        ...
        <Box sx={{ backgroundColor: '#ffffff', color: '#333333' }}>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
                                    ...
                                    {[th1, th2, th3].map((img, index) => (
                                        <Grid item xs={4} key={index}>
                                            <CardMedia
                                                component="img"
                                                image={img}
                                                alt={`Punta Mosquito thumbnail ${index + 1}`}
                                                sx={{
                                                    borderRadius: '12px',
                                                    width: '100%',
                                                    height: 'auto'
                            ...
                            <Box>
                                ...
                                <Typography variant="body1" sx={{ lineHeight: '30px', mb: 2, fontFamily: "Playfair Display" }}>
                                    {zona ? zona.descripción : 'Punta Mosquito is a stunning natural sandbar located northeast of Holbox Island, famous for its crystal-clear shallow waters and abundant wildlife. This ecological sanctuary is home to flamingos, pelicans, and many other bird species. The tour includes a boat ride through the beautiful waters of the Yalahau Lagoon, time to explore the sandbar, snorkeling in the pristine waters, and opportunities to observe the rich biodiversity of this protected area.'}
                                </Typography>
                            </Box>
                            ...
                            <Box>
                                ...
                                <Box sx={{ borderRadius: '25px', overflow: 'hidden' }}>
                                    <iframe
                                        ...
                                        frameBorder="0"
                                        style={{ border: 0 }}
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3710.594822354745!2d-87.34318451834159!3d21.562692829231587!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f4d9170c972556d%3A0x1b207fa92ee65814!2sPunta%20Mosquito!5e0!3m2!1ses-419!2smx!4v1754045467035!5m2!1ses-419!2smx">
                                        allowFullScreen=""
                                        loading="lazy"
                            ...
                            <Box>
                                <List sx={{ width: '100%', bgcolor: 'transparent', padding: 0 }}>
                                    {[
                                        { icon: Groups, text: 'Group size: 4-12 people' },
                                        { icon: Schedule, text: 'Duration: 4-5 hours' },
                                        { icon: Paid, text: 'Price: $80-$100 per person' },
                                        { icon: DirectionsBus, text: 'Includes: Boat, guide, snorkel gear' }
                                    ].map((item, index) => (
            ...
            <Box sx={{ py: 7.5, borderTop: '1px solid rgba(0,0,0,0.1)', overflow: 'hidden', marginBottom: '100px' }}>
                <Container maxWidth="lg">
                    ...
                    >
                        See What Travelers Are Saying About Punta Mosquito
                    </Typography>
                        ...
                        {[
                            {
                                ...
                                comment:
                                    "Punta Mosquito was the highlight of our Holbox trip! Seeing flamingos in their natural habitat was incredible. The water is so clear and shallow you can walk for hundreds of meters. Our guide was very knowledgeable about the ecosystem.",
                            },
                            {
                                image: lg2,
                                name: 'Thomas Müller',
                                ...
                                comment:
                                    "An absolute paradise! The sandbar stretches forever and the water is like a swimming pool. We saw so many birds and marine life. The boat ride there was also beautiful, passing through mangroves and shallow waters.",
                            },
