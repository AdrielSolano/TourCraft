...
const TulumRuinsTour = () => {
    ...
    useEffect(() => {
        const idZona = "688bd6ecf77e1f6903e19c75";
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
                            <Box>
                                <CardMedia
                                    ...
                                    alt="Tulum Ruins Tour main view"
                            ...
                            <Box>
                                <List sx={{ width: '100%', bgcolor: 'transparent', padding: 0 }}>
                                    {[
                                        ...
                                        { icon: Paid, text: 'Entry Fees: $65 per person' },
