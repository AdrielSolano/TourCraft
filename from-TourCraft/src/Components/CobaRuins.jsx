...
import cobaMain from "../assets/coba.jpg";
...
const iconMap = {
    "Archaeological Site": Explore,
    "Historical": DirectionsWalk,
    "Nature": DirectionsBus,
    "Adventure": CardTravel,
};
...
const texts = [
    ...
    "Professional guide available for hire",
    "Ancient Mayan ruins with impressive structures",
    "Climb the Nohoch Mul pyramid (42 meters tall)",
    "Explore the network of sacbeob (ancient roads)"
];
...
const CobaRuins = () => {
    ...
    const getDescription = () => {
        ...
        return 'The Coba Ruins are one of the most important Mayan archaeological sites in the Yucatan Peninsula. This ancient city features the tallest pyramid in the region, Nohoch Mul, which visitors can climb for spectacular jungle views. The site includes numerous temple structures and an extensive network of ancient causeways (sacbeob) that connected various parts of the city.';
    };
    ...
    useEffect(() => {
        const idZona = "688bd630f77e1f6903e19c75"; // Update with Coba Ruins ID if available
                    ...
                    <Grid item xs={12} md={6}>
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
                            ...
                            <Box>
                                ...
                                <iframe
                                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1868.7065666633118!2d-87.72869561120568!3d20.489283657785066!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f51cf4e4fe2c6a9%3A0xebab98a197ae8e56!2sCoba%20Pyramid%20Ruins!5e0!3m2!1ses!2smx!4v1754039436090!5m2!1ses!2smx"
                                  width="100%"
                                  height="400"
                                  style={{ border: 0 }}
                                  allowFullScreen=""
                            ...
                            <Box>
                                <List sx={{ width: '100%', bgcolor: 'transparent', padding: 0 }}>
                                    {[
                                        { icon: Groups, text: 'Group size: 1-15' },
                                        { icon: Schedule, text: 'Duration: 3-4 hours' },
                                        { icon: Paid, text: 'Entry Fees: $80 MXN per person' },
                                        { icon: DirectionsBus, text: 'Distance from Tulum: 47 km' }
                                    ].map((item, index) => (
