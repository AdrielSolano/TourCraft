...
import frame341 from "../assets/muyil.jpeg";
...
const texts = [
    ...
    "Entrance fee: $100 MXN per person",
...
const MuyilLagoon = () => {
    ...
    const getDescription = () => {
        ...
        return 'Muyil Lagoon is a pristine natural wonder located within the Sian Ka\'an Biosphere Reserve. This tranquil lagoon features crystal clear waters, abundant birdlife, and ancient Mayan ruins nearby. Visitors can enjoy boat tours, bird watching, and swimming in this untouched paradise. The lagoon connects to a series of canals built by the ancient Maya, offering a unique opportunity to experience both natural beauty and archaeological wonders.';
    };
    ...
    useEffect(() => {
        const idZona = "688bd630f77e1f6903e19c75"; // Update with Muyil Lagoon ID
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
                            ...
                            <Box>
                                ...
                                <Box sx={{ borderRadius: '25px', overflow: 'hidden' }}>
                                  <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3747.385592823898!2d-87.60802672417627!3d20.07616196981306!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f502703e0f3d61f%3A0xc507fa95fe789313!2sLaguna%20de%20Muyil!5e0!3m2!1ses!2smx!4v1754043152905!5m2!1ses!2smx"
                                    width="100%"
                                    height="400"
                                    style={{ border: 0 }}
                                    allowFullScreen=""
                            ...
                            <Box>
                                <List sx={{ width: '100%', bgcolor: 'transparent', padding: 0 }}>
                                    {[
                                        { icon: Groups, text: 'Group size: 1-8' },
                                        { icon: Schedule, text: 'Duration: 3-4 hours' },
                                        { icon: Paid, text: 'Entry Fees: $100 MXN per person' },
                                        { icon: DirectionsBus, text: 'Distance from Tulum: 25 km' }
                                    ].map((item, index) => (
